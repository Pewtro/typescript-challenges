...
type BothTypesOfArray = Array<any> | ReadonlyArray<any>;
type Concat<T extends BothTypesOfArray, U extends BothTypesOfArray> = T extends BothTypesOfArray
  ? U extends BothTypesOfArray
    ? [...T, ...U]
    : never
  : never;
